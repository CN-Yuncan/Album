      ...
      await prisma.$transaction(async (tx) => {
        ...
        await tx.configs.createMany({
          data: [
            ...
            { config_key: 'cos_bucket', config_value: '', detail: '腾讯云 COS 存储桶名称，如：picimpact-123456789' },
            { config_key: 'cos_storage_folder', config_value: '', detail: '存储文件夹(腾讯云 COS)，严格格式，如：picimpact 或 picimpact/images ，填 / 或者不填表示根路径' },
